...
This file is the original dataset description that used to sit at the repository root. Training code lives in `packages/ml`. The product README is at the repository root.
...
For more questions about the dataset, contact William Wang, william@cs.ucsb.edu
